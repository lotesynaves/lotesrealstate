              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                      {Object.entries(property.features).map(([key, value]) => {
                        ...
                        const featureLabels: Record<string, string> = {
                          ...
                          buildedArea: 'Área de construcción',
                ...
                <div className="space-y-6">
                  <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                    ...
                    <Button
                      onClick={() => window.location.href = 'mailto:propiedades@navesylotesindustriales.com'}
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400 space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <a 
                          href="mailto:propiedades@navesylotesindustriales.com" 
                          className="break-words hover:text-blue-600 dark:hover:text-blue-400 transition-colors max-w-[20ch]"
                        >
